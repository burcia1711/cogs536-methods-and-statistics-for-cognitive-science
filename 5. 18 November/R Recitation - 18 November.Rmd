# Song Sparrow Cognition Data Analysis Lab

This lab session will guide you through essential data analysis techniques in R, including descriptive statistics, visualization, data manipulation, and introductory inferential statistics. We will be using a dataset on **Song Sparrow cognition**.
...
| **Mode** | `calculate_mode()` | The most frequently occurring value. |
...
mode_val <- calculate_mode(neophobia_scores)
cat("Mode(s):", mode_val, "\n")
...
Convert factor/character labels into numeric IDs:
This produces:
...
No warning, because factor → numeric conversion is safe.
